...
class WxPayConfig
{
     ...
     * @var string
     */
    const APPID = 'wx1800872e18acc8f7';
    const MCHID = '1494076972';
    const KEY = 'DNfekiyqmnNUg53bgD8qfMcVDX10H4ev';
    const APPSECRET = '03b564744dffd2cc239250437ee139db';
    const NOTIFY_URL = "http://teacherpu.top/index/wxpay/notify";
