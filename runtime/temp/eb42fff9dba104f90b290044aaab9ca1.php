<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpstudy\WWW\aiyy\public/../application/user\view\news\index.html";i:1517208395;s:54:"D:\phpstudy\WWW\aiyy\application\user\view\layout.html";i:1516959785;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="xiaoxi-1">
        <div class="lis">
            ...
            <a href="show.html">
                ...
                <dd>充值新消息查看<?php if($data->recharge->recharge_num) echo '('.$data->recharge->recharge_num.')' ?></dd>
                </dl>
            </a>
            <?php 
                    }
                if($data->upgrademember->info_num){
             ?>
                <a href="vip.html">
                    <dl><img src="__HOME_CSS__/wapcssjsimg/images/xiaoxi-1.png" class="falai" >
                        <dt>
                            <b>会员升级消息小助手</b><p>10:41</p>
                        </dt>
                        <dd>会员升级新消息查看<?php if($data->upgrademember->upgrademember_num) echo '('.$data->upgrademember->upgrademember_num.')' ?></dd>
                    </dl>
                </a>
             <?php } ?>
        </div>
