var flyZommImg = function(b, a) {
    ...
    this._opts = {
            ...
            $("body").on("click", ".fly-zoom-box-label",
                function(f) {
                    ...
                    if (g && c.groups && c.groups[c.group_name]) {
                        ...
                        $(".fly-zoom-box-img").attr("src", c.groups[c.group_name][0].dom.attr("src"));
        ...
        this._flyBoxHtml = function(h) {
            var c = parseInt(h.data("index"));
            if (this.group_show) {
        ...
        this._rightMove = function() {
            ...
            if (e.group_show) {
                ...
                e.opts.img_index = c;
                var f = e.groups[e.group_name][c].dom
            } else {
            ...
            $(".fly-zoom-box-main").append("<img class='fly-zoom-box-img' data-index='" + c + "'  style='left:100%;display: block;position: absolute;' src='" + f.attr("src") + "'>");
            e._imgRestore("chage", f);
            $(".fly-zoom-box-img").animate({
                ...
                function() {
                    e._touchBind(e);
                    e._imgRestore("switcher", f)
                });
            this._moveUnBind(c);
            if (this._activity) {
                this.opts.slitherCallback("left", f)
            }
        },
        this._leftMove = function() {
            ...
            $(".fly-zoom-box-main").append("<img class='fly-zoom-box-img' data-index='" + c + "'  style='right:100%;display: block;position: absolute;' src='" + f.attr("src") + "'>");
            e._imgRestore("chage", f);
            $(".fly-zoom-box-img").animate({
                    right: "0%"
                },
            ...
            this._moveUnBind();
            if (e._activity) {
                this.opts.slitherCallback("right", f)
            }
        },
